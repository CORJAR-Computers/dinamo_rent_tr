<script lang="ts">
	...
	let { renta, cliente, auto }: { renta: Renta; cliente?: Cliente; auto?: Auto } = $props();
...
<div class="print-area contrato-carta bg-white text-black contrato-body px-6 py-6">
	...
	<div class="encabezado-principal">
		...
		<div class="info-contacto">
			...
			{#if empresa.webMostrar}<p style="margin: 2px 0 0 0; font-size: 6.5pt;">
					{empresa.webMostrar}
				</p>{/if}
		</div>
	</div>
	...
	<div class="seccion-partes">
		...
		<p>
			...
			{renta.nombreCliente}, identificado con
			<span class="campo-resaltado">{tipoDoc} No: {noDoc}</span>, nacionalidad
			<span class="campo-resaltado">{nacionalidad}</span>, licencia tipo
	...
	<div class="clausula-contenido">
		<span class="negrita">PRIMERO:</span>
		{razonSocial} es único y exclusivo poseedor del vehículo anteriormente descrito.
	</div>
	<div class="clausula-contenido">
		<span class="negrita">SEGUNDO:</span> Por este acto {razonSocial} viene en dar en arrendamiento el
		vehículo antes singularizado, a quien lo acepta y recibe para sí y para destinarlo a su uso.
	</div>
	...
	<div class="clausula-contenido">
		...
		especialmente del sistema de frenos, luces de estacionamiento, de freno, de tránsito y de
		viraje, así como el cinturón de seguridad en perfectas condiciones de uso, por lo cual el mismo
		hará entrega a {razonSocial} el valor de los bienes por la pérdida o daño de estos por cualquier naturaleza.
	</div>
	...
	<div class="clausula-contenido">
		...
		arriendo y de más costos que se deriven del mismo sin necesidad de aviso previo, siempre que
		medie incumplimiento por parte del ARRENDATARIO, por valor de <span class="campo-resaltado"
			>$2.500.000 M/L</span
		...
		incumplimiento el mismo y por lo tanto el ARRENDATARIO deberá devolver el vehículo
		inmediatamente y no se hará ningún tipo de reembolso por parte de la ARRENDADORA. Según las
	...
	<div class="clausula-contenido">
		...
		<span class="campo-resaltado">{formatDate(renta.fechaRecogida)}</span>, y por fecha de término
		el
		<span class="campo-resaltado">{formatDate(renta.fechaRetorno)}</span>. Al término del
		arrendamiento el arrendatario deberá devolver el vehículo en el estado en que lo recibió, a las
		<span class="campo-resaltado">{hora(renta.horaRetorno)}</span> horas, vencido el cual podrá
		solicitarse el secuestro de este, por parte de la ARRENDADORA. La duración del arrendamiento
		surge del plazo anteriormente establecido, no pudiendo EL ARRENDATARIO alegar la tácita
		renovación automática del arrendamiento por ningún motivo; salvo estipulación en contrato
		celebrada entre las partes, pues de pretenderse la renovación o extensión del presente contrato,
		esta deberá ser notificada a la ARRENDADORA en un término mínimo de 48 horas, de forma que la
		ARRENDADORA pueda verificar la disponibilidad y viabilidad en la extensión de la entrega, quien
		podrá recuperarlo en cualquier momento y en forma que estime más conveniente a sus intereses,
		sin que EL ARRENDATARIO pueda oponer excepción alguna. El plazo en exceso del término convenido
		será pagado por EL ARRENDATARIO de conformidad con las tarifas plenas en vigencia para el
		alquiler del vehículo tomado en renta. De igual manera en los casos donde se presenta la entrega
		anticipada del vehículo a LA ARRENDADORA, se entenderá como incumplimiento parcial de la
		convención por lo cual será responsabilidad del ARRENDATARIO el pago de los días restantes para
	...
	<div class="clausula-contenido">
		Vencido el plazo EL ARRENDATARIO debe devolver el vehículo alquilado de forma inmediata en el
		mismo estado en que lo recibió y en domicilio del ARRENDADOR salvo estipulación en contrario
		celebrada entre las partes que acuerden como lugar de entrega del vehículo, alguno diferente
		para lo cual será el ARRENDATARIO quien deberá asumir los costos adicionales que de este
		contrato se deriven; tales como peajes, gasolina, parqueadero y gastos de movilización del
		conductor. Esta estipulación deberá ser anotada en la parte inferior del presente contrato. De
	...
	<div class="clausula-contenido">
		...
		ilícitas. Tampoco podrá ser conducido bajo la influencia del alcohol o en estado de ebriedad o
		bajo la influencia de sedantes, somníferos o drogas. EL ARRENDATARIO deberá portar al momento de
		la conducción todos sus documentos de identificación personal y de conductor. EL ARRENDADOR hace
	...
	<ol class="lista-numerada">
		<li>
			Deberá manejarlo personalmente (o lo manejará su conductor, esta persona deberá estar
			registrada ante la ARRENDADORA).
		</li>
		<li>
			No podrá subarrendarlo, cederlo o disponer de él en ninguna forma sin el consentimiento
			expreso manifestado por escrito por el ARRENDADOR, pues de lo contrario el ARRENDADOR podrá
			celebrar un nuevo contrato con los usuarios reales, sin necesidad de requerimientos judiciales
			o privados, a los cuales renuncia el ARRENDADOR.
		</li>
		<li>
			Conducir el vehículo en zonas fronterizas y FUERA DEL TERRITORIO DE LA REPUBLICA DE COLOMBIA,
			o fuera de CARTAGENA sin conocimiento y autorización expresa DEL ARRENDADOR; la sanción
			estipulada para lo anterior es $1000 M/T por KM recorrido por auto económico, compacto y sedan
			sencillo y $1500 M/T por KM por un automóvil Sedan de lujo y cualquier tipo de Camioneta, la
			distancia se calcula desde CARTAGENA como punto de origen hasta el lugar que el auto salió sin
			autorización sumando el recorrido de ida y regreso.
		</li>
		<li>
			Bajo las influencias de sustancias psicoactivas o alcohol, en estado de ebriedad cuando este
			bajo los efectos de calmantes, tranquilizantes o narcóticos. ESTA TOTALMENTE PROHIBIDO FUMAR,
			REGAR BEBIDAS, MOJAR LOS ASIENTOS CON AGUA DE MAR ETC, EL INCUMPLIMIENTO TENDRA UN CARGO DE
			$150.000.
		</li>
		<li>
			Conducir sin licencia valida, expedida por las autoridades competentes y aceptadas por las
			autoridades colombianas.
		</li>
		<li>
			Permitir conducir personas menores de edad y por ningún motivo y en ninguna circunstancia
			conducir un vehículo rentado.
		</li>
		<li>El transporte de personas en violación a la ley o bajo falsa identidad.</li>
		<li>
			En pruebas de competencias y velocidad o participar con el vehículo en carreras
			automovilísticas, por regularidad, etc., o certámenes de cualquier otro tipo, bajo ningún
			pretexto.
		</li>
		<li>En violación de la regla de tránsito o transporte de sobrecupo de pasajeros.</li>
		<li>
			Para el transporte, movilización o almacenamiento de sustancias de estupefacientes, armas de
			fuego o municiones, materiales inflamables, explosivos, combustibles o carburantes, en el
			momento de transgredir esta obligación o misiva, será el ARRENDATARIO responsable de los
			hechos que se deriven.
		</li>
		<li>
			Efectuar cualquier tipo de negociación particular sobre los vehículos rentados tales como
			ventas, depósito en prendas de cambio y en general cualquier tipo de convención que afecte o
			altere de algún modo la propiedad privada del vehículo, mediante la falsificación o copia no
			autorizada de los documentos del vehículo.
		</li>
	</ol>
	...
	<div class="clausula-contenido">
		...
		{ciudadClausula}, mediante un sorteo efectuado entre los árbitros inscritos en las listas que
		lleva el centro de arbitraje y conciliación mercantiles de dicha cámara. EL tribunal se sujetará
		a lo dispuesto en el decreto 1818 de 1998 o estatuto orgánico de los sistemas alternos de
		solución de conflictos y demás normas concordantes de acuerdo con las siguientes reglas: a) el
		tribunal estará integrado por 5 árbitros; b) la organización interna del tribunal se sujetará a
		las reglas previas en el centro de arbitraje y conciliación mercantiles; c) el tribunal decidirá
		en derecho, en conciencia o en principios técnicos; d) el tribunal funcionará en el centro de
		arbitraje y conciliación mercantiles. A tal efecto constituye domicilio en {ciudadClausula}.
	</div>
	<div class="clausula-contenido">
		Debido a lo anterior se deja especial constancia que la anterior declaración es determinante
		para celebrar el presente contrato. Si la declaración antes mencionada resultase ser falsa, el
	...
	<div class="clausula-contenido">
		...
		valor del contrato a título de pena, o en caso de depósito de seguridad necesario para la renta
		del vehículo la pérdida de este en su totalidad, además de responder económicamente por los
		perjuicios que pudieren ocasionarse como consecuencia del incumplimiento.
	</div>
	...
	<ol class="lista-numerada">
		<li>
			La inmovilización del vehículo rentado por un término superior a 24 horas, cualquiera sea la
			causa de esta, y siempre que esta afecte de forma directa a los intereses de la empresa.
		</li>
		<li>
			La constante imposibilidad de comunicación entre los representantes de la ARRENDADORA y el
			ARRENDATARIO de forma que se bloquee el conocimiento pleno del estado del vehículo.
		</li>
		<li>La entrega tardía o anticipada del vehículo rentado.</li>
		<li>
			El no tener cupo de seguridad disponible en la tarjeta de crédito durante la vigencia de la
			renta del vehículo y no ser otorgada la renovación para la autorización de este por el banco
	...
	<div class="clausula-contenido">
		...
		ARRENDADORA autorizada para retirar el vehículo del lugar donde se encuentre por medio de
		cualquiera de sus empleados y mediante los duplicados que tienen en su poder. EL ARRENDATARIO
		autoriza y acepta que el incumplimiento en el pago de las obligaciones económicas adquiridas en
		el presente contrato dará lugar a un reporte negativo a su historia crediticia con {razonSocial} a
		todas las centrales de riesgo como pro crédito y data crédito. Las controversias a las distintas cláusulas
		de este contrato configurarán para el ARRENDATARIO la consumación de los delitos penales que las circunstancias
		indiquen.
	</div>
	...
	<div class="clausula-contenido">
		EL ARRENDATARIO es enteramente responsable mientras permanezca en la tenencia del automóvil de
		la guardia material y jurídica del mismo asumiendo todas las responsabilidades civiles y penales
		que tal condición implica, hasta tanto proceda a su devolución AL ARRENDADOR y respondiendo
		...
		caso de siniestro el ARRENDATARIO deberá resarcir al ARRENDADOR a su compañía de seguros
		mediante el pago de los valores deducibles de la póliza de seguros los perjuicios que puedan
		ocasionarse. Si el pago se diera por medio distinto al efectivo aceptará pagar los recargos
		correspondientes a impuestos, comisiones financieras, retenciones, cuatro por mil entre otros
		pagos necesarios que se puedan derivar de la siguiente convención. En caso de lo contrario se
		procederá a ejecutar el correspondiente cobro jurídico para lo cual este contrato presta mérito
		ejecutivo sin necesidad de requerimiento privado ni judicial a las cuales renuncian expresamente
		el ARRENDATARIO. Por lo anterior el ARRENDADOR acepta las condiciones de la limitación de la
		póliza para vehículos en accidentes, muertes o lesiones y la cobertura por responsabilidad civil
		y terceras personas, la cual queda incorporada a este contrato.
	</div>

	<!-- CLÁUSULA DÉCIMA PRIMERA -->
	<div class="clausula-titulo">CLÁUSULA DÉCIMA PRIMERA: SEGURO DE LUCRO CESANTE</div>
	<div class="clausula-contenido">
		EL ARRENDATARIO podrá tomar a su cargo el costo adicional por el seguro de lucro cesante, a raíz
		de daños causados al vehículo objeto del ARRENDAMIENTO, cualquiera fuere la índole del hecho que
		dé como resultado imposibilidad física y/o jurídica de afectación del vehículo al servicio de
		alquiler. El valor de dicha póliza se encuentra expresamente contemplado dentro del presente
		contrato y de ser tomado por un día corriente de alquiler del vehículo mientras persista el
		término de ejecución del mismo. Este pago no exime al ARRENDATARIO de hacer frente a los gastos
		de recuperación o reparación del vehículo mediante el pago del valor del deducible de la póliza
		de seguro exigido por la aseguradora; y en caso de presentarse estos hechos o en caso de
		cualquier accidente, EL ARRENDATARIO deberá dar aviso inmediato al ARRENDADOR y a las
		autoridades no pudiendo exceder el lapso para hacerlo de 24 horas de ocurrido el mismo. De no
		dar previo aviso EL ARRENDADOR será responsable del pago total e íntegro del valor del lucro
		cesante que resultare del siniestro, o inmovilización del vehículo en la tarifa plena la cual
		fue rentada el vehículo.
	</div>
	...
	<div class="poliza-container">
		...
		<p style="margin: 6px 0 0 0; text-indent: 0;">
			De ocurrir algún siniestro o accidente de cualquier naturaleza, el arrendatario deberá dar
			aviso de inmediato al arrendador y concurrir hasta la unidad policial más cercana para dejar
	...
	<div class="clausula-contenido">
		...
		arrendatario se obliga y compromete al fiel cumplimiento de las normas sobre regulación de
		tránsito debiendo responder personalmente por el pago de las multas o indemnizaciones a que
		resultare obligado o condenado.
	</div>
	...
	<ol class="lista-numerada">
		...
		<li>
			Protección por daños ocasionados a terceras personas que no constituyan pasajero del vehículo.
		</li>
		<li>
			Protección por daños a dos o más personas que no se constituyan en pasajero del vehículo.
		</li>
		<li>
			El vehículo rentado tendrá una cobertura de aseguramiento correspondiente al 90% quedando en
			cabeza del arrendatario la obligación de asumir el pago del valor deducible de la póliza de
			seguridad exigido por la aseguradora correspondiente al 10% que deberá ser pagado íntegramente
			y de forma inmediata por el arrendatario.
		</li>
		<li>
			La empresa aseguradora no se hará responsable del reconocimiento de pago en casos de
			siniestros o daños ocasionados al vehículo por valores inferiores a $2.500.000 (DOS MILLONES
			QUINIENTOS MIL PESOS M/L). Este valor de $2.500.000, y daños superiores a este correspondería
			al 10% del valor del siniestro en general. Daños a terceros tiene una cobertura del 100%.
		</li>
		<li>
			Asistencia médica prioritaria en accidente de tránsito, incluida la movilización de heridos a
			centros hospitalarios.
		</li>
		<li>Asistencia legal.</li>
		<li>
			Asistencia en caso de fallas técnicas a nivel nacional, que imposibiliten el uso del vehículo
			tomado en arriendo.
		</li>
	</ol>
	<div class="clausula-contenido">
		El arrendatario se obliga a tomar un seguro por el vehículo arrendado, contra todo riesgo, a
		favor del arrendador por la cantidad de $<span class="campo-resaltado"
			>____________________</span
		>. Son de cargo del arrendatario: a) los daños ocasionados al vehículo o a sus accesorios, por
		sí o por un tercero, aun por caso fortuito; b) los daños que se causen a terceros; c) los
		perjuicios que pueda experimentar por causa de robo.
	</div>
	...
	<div class="clausula-contenido">
		...
		período de vigencia de este contrato, AUTORIZANDO a {razonSocial} (EL ARRENDADOR) para efectuar la
		cobranza de las mismas, acrecidas en 15% (QUINCE POR CIENTO) como cargo de gestión administrativa,
		automáticamente de la tarjeta de crédito presentada como garantía en este contrato de arrendamiento
		de vehículo. La empresa no es responsable de asumir y asistir a cursos de tránsito para generar descuentos
		en las fotomultas, en caso de presentarse algún problema con el cobro correspondiente a lo acordado
		en la siguiente cláusula en relación a la tarjeta de crédito el ARRENDADOR en los términos anteriormente
		descritos. Si pasados los 5 días hábiles contados a partir de enviado el correo electrónico el ARRENDATARIO
		no se ha comunicado con el ARRENDADOR para acordar el pago de lo debido según la presente cláusula
		se iniciará en contra del ARRENDATARIO el respectivo cobro pre jurídico y jurídico con reporte a las
		centrales de riesgo. El ARRENDATARIO asumirá todos los gastos correspondientes al respectivo proceso.
	</div>
	...
	<div class="firmas-container">
		<p style="text-indent: 0;">En comprobante de previa lectura, ratifican y firman:</p>

		<div class="firma-linea"></div>
		<p style="margin: 2px 0; text-indent: 0; font-weight: bold;">Arrendador</p>
		<p style="margin: 2px 0; text-indent: 0;">
			{razonSocial}{#if empresa.nitMostrar}
				· RUT {empresa.nitMostrar}{/if}
		</p>
		...
		<p style="margin-top: 18px; text-indent: 0;">
			Firmaron ante mí en las calidades que comparecen. {empresa.ciudadMostrar}{#if empresa.ciudadMostrar},
			{/if}{hoy}.
		</p>
	</div>
