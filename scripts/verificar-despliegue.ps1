# verificar-despliegue.ps1 - Verificacion post-instalacion de DinamoRent v1.0.14
#
...
#
# Comprueba: exe instalado (v1.0.14), %APPDATA%\com.corjar.dinamorent (config.ini
...
if ($exe) {
    ...
    Check "Version 1.0.14" ($ver -like '1.0.14*') "ProductVersion=$ver"
} else {
