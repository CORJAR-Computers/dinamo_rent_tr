# verificar-despliegue.ps1 - Verificacion post-instalacion de DinamoRent v1.0.16
#
...
#
# Comprueba: exe instalado (v1.0.16), %APPDATA%\com.corjar.dinamorent (config.ini
...
if ($exe) {
    if ($DryRun) {
        $ver = if ($SimularFallo) { '1.0.15.0' } else { '1.0.16.0' }
    } else {
