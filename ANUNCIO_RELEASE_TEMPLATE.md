...
- **Assets de la v1.0.15:** `DinamoRent_1.0.15_x64-setup.exe` (NSIS, ~21 MB, sha256 `(pendiente — se calcula al publicar)`) y `DinamoRent_1.0.15_x64_en-US.msi` (~33 MB, sha256 `(pendiente — se calcula al publicar)`)
