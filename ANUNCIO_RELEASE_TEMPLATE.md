...
datos reales de la v1.0.24** (enlaces, sha256, conteos de tests) — copiar el
...
```text
🚀 Dinamo Rent ERP — v1.0.24 publicada (fix hora real de cierre en tabla de rentas + tipos generados)

La versión v1.0.24 ya está publicada en GitHub, construida y firmada
por CI (auto-update activo desde la v1.0.14).

📦 Descarga: release v1.0.24 → https://github.com/CORJAR-Computers/dinamo_rent_tr/releases/download/v1.0.24/DinamoRent_1.0.24_x64-setup.exe
(~22 MB, NSIS) o el .msi (~34 MB): https://github.com/CORJAR-Computers/dinamo_rent_tr/releases/download/v1.0.24/DinamoRent_1.0.24_x64_en-US.msi
sha256 NSIS: a3b1567b7d3442a61d9bf2851035504a3a1892eb13153c3955bdd9a67c29700f
sha256 MSI:  4bbe2619c5bfa0bd57c298b8ad12bb957cfcaec7ad071b3004803753dc6d5ab2
...
```text
🚀 Dinamo Rent ERP v1.0.24 publicada y firmada por CI. Fix: edición de renta cerrada (campos numéricos convertidos a string para el backend). Auto-update desde v1.0.14.
...
Descarga: https://github.com/CORJAR-Computers/dinamo_rent_tr/releases/tag/v1.0.24
```
...
- **Assets de la v1.0.24:** `DinamoRent_1.0.24_x64-setup.exe` (NSIS, ~22 MB, sha256 `a3b1567b7d3442a61d9bf2851035504a3a1892eb13153c3955bdd9a67c29700f`) y `DinamoRent_1.0.24_x64_en-US.msi` (~34 MB, sha256 `4bbe2619c5bfa0bd57c298b8ad12bb957cfcaec7ad071b3004803753dc6d5ab2`)
- **Credenciales iniciales:** `admin` / `admin123` (cambio forzado)
- **URLs directas de assets v1.0.24:**
  - NSIS: https://github.com/CORJAR-Computers/dinamo_rent_tr/releases/download/v1.0.24/DinamoRent_1.0.24_x64-setup.exe
  - MSI: https://github.com/CORJAR-Computers/dinamo_rent_tr/releases/download/v1.0.24/DinamoRent_1.0.24_x64_en-US.msi
  - Release (con changelog automático de commits): https://github.com/CORJAR-Computers/dinamo_rent_tr/releases/tag/v1.0.24
  - Firmas del updater: `DinamoRent_1.0.24_x64-setup.exe.sig` / `DinamoRent_1.0.24_x64_en-US.msi.sig`
...
- **Assets de la v1.0.24 (al publicar):** los 2 instaladores, sus firmas del updater y `latest.json`. El sha256 se calcula al publicar y se pega en esta sección.
