...
>
> **📋 Objetivo actual: v1.0.22 (preparando).**
...
**Features v1.0.17 (incluidas en v1.0.22):**
...
## Pendiente para la v1.0.22

- [ ] Bump a v1.0.22 en los 3 archivos (§2)
- [ ] Verificación local con `-DryRun` (§3)
- [ ] Commit `chore: versión 1.0.22` + tag `v1.0.22` (§4-5)
- [ ] Prueba de campo en máquina real — auto-update de v1.0.17→v1.0.22 (§6)
