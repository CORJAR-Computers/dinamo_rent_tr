...
>
> **📋 Objetivo actual: v1.0.23 (preparando).**
...
**Features v1.0.17 (incluidas en v1.0.23):**
...
## Pendiente para la v1.0.23

- [ ] Bump a v1.0.23 en los 3 archivos (§2)
- [ ] Verificación local con `-DryRun` (§3)
- [ ] Commit `chore: versión 1.0.23` + tag `v1.0.23` (§4-5)
- [ ] Prueba de campo en máquina real — auto-update de v1.0.17→v1.0.23 (§6)
